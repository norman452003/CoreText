...
#pragma mark - 添加的传入解析json字符串方法
+ (CoreTextData *)pareeJSONString:(NSString *)jsonStr config:(CTFrameParserConfig *)config{
    
    NSMutableArray *imageArray = [NSMutableArray array];
    NSMutableArray *linkArray = [NSMutableArray array];
    NSAttributedString *content = [self loadJSONStr:jsonStr config:config imageArray:imageArray linkArray:linkArray];
...
+ (NSAttributedString *)loadJSONStr:(NSString *)jsonStr
